...
LIEB's output is rich for exploration. For example, in our manuscript, we analyze CTCF ChIP-seq data from 17 murine hematopoietic cell lineages collected as part of the VISION project. You can explore some of the results with [the VISION Shiny App](https://github.com/hillarykoch/vision_shiny).
