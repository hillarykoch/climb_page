...
fits <- get_pairwise_fits(z = sim$data, nlambda = 10, parallel = FALSE)
```
...
Finally, save this output, as it is necessary for many parts of the downstream analyses.
```{r, eval = FALSE}
saveRDS(fits, file = "pwfits.rds")
```