...
You can run an mcmc simply with the function `run_mcmc()`. This function calls a script written in [Julia](https://julialang.org/), and executes everything at the default settings in the LIEB methodology. The user needs to provide 4 arguments:
