...
In some cases, such as input from a peak-calling routine, this is straightforward. In others, such has right-skewed data like RNA-seq, preparation is slightly less so. Here, we walk through steps used for the data analyses in the CLIMB manuscript, with a brief discussion of alternatives.
